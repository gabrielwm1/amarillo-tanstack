...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        brand: "border-transparent bg-brand-9 text-neutral-1",
        secondary: "bg-neutral-1 text-neutral-11 border-neutral-6",
        error: "border-transparent bg-red-9 text-neutral-1",
      },
    },
    defaultVariants: {
      variant: "brand",
